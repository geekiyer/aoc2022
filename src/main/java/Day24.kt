import models.Coord
import models.CoordRange

fun main() {
    val inputSequence = object {}.javaClass.getResourceAsStream("day24.txt")?.bufferedReader()?.readLines()!!
    println(Day24(inputSequence).part1())
    println(Day24(inputSequence).part2())
}
